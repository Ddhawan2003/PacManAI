...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        # Compute the most likely position of each ghost
        mostLikelyGhostPositions = [max(distribution, key=distribution.get)
                                    for distribution in livingGhostPositionDistributions]

        # Find the closest ghost to Pacman
        closestGhost = min(mostLikelyGhostPositions,
        ...
        for action in legal:
            ...
            distanceToGhost = self.distancer.getDistance(successorPosition, closestGhost)
